...
// Анатация @Disabled не будет запускать ваш тесты, он будет отображается в колонке RUN.
@Tag("SMOKE")
/* Анатация @Tag конкретезирует проверки чтоб запускать с определенным тегом, тег можно ставить
над классом как в моём случаи лиюо ставить в самом тесте если в класе имеются ждругие теги
